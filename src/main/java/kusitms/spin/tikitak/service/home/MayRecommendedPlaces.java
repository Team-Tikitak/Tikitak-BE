...
class MayRecommendedPlaces {
	...
	private static final String BASE = "https://pub-26c0a3a5035c4cfb807acd26bc5c9591.r2.dev/recommend_place/";

	static final List<HomeResponseDTO.RecommendedPlaceItemDTO> ALL = List.of(
		item("앤트러사이트 서교점",
		...
		item("KT&G 상상마당 홍대",
			...
			"https://map.kakao.com/link/search/KT%26G상상마당홍대"),
		item("연남살롱",
		...
		item("소바하우스 멘야준",
			...
			"https://map.kakao.com/link/search/테라로사홍대서교"),
		item("하쿠텐",
